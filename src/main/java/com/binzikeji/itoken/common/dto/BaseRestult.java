package com.binzikeji.itoken.common.dto;
...
public class BaseRestult implements Serializable {
    ...
    public static BaseRestult ok(String muccess, Object data){
        return createResult(RESTULT_OK, data, muccess, null, null);
    }
    ...
    public static BaseRestult notOk(List<BaseRestult.Error> errors){
